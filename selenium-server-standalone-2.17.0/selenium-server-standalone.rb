...
class SeleniumServerStandalone < Formula
  ...
  def install
    prefix.install "selenium-server-standalone-2.17.0.jar"
...
Or start it manually with:
  java -jar #{prefix}/selenium-server-standalone-2.17.0.jar -p 4444
EOS
  end
...
<dict>
        ...
        <array>
                ...
                <string>-jar</string>
                <string>#{prefix}/selenium-server-standalone-2.17.0.jar</string>
                <string>-port</string>
                <string>4444</string>
        </array>
